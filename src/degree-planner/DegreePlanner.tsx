...
const DegreePlanner = () => {
    ...
    return (
        <div
            className="flex flex-col h-screen overflow-hidden bg-slate-100 dark:bg-slate-900 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-200">
            {/* HEADER */}
            <div
                className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm z-40 px-6 py-3 flex justify-between items-center shrink-0 transition-colors">
                <div className="flex items-center gap-6">
                    ...
                    <div className="relative group select-none">
                        <h1 className="text-3xl font-extrabold relative z-10 py-1 px-2 flex items-center">
                            ...
                            <div
                                className="absolute -right-2 -top-4 w-20 h-20 opacity-20 z-[-1] pointer-events-none rotate-12">
                                <img
                            ...
                            {/* Gradient Text */}
                            <span
                                className="bg-linear-to-r from-yellow-600 to-amber-700 dark:from-yellow-400 dark:to-amber-500 bg-clip-text text-transparent drop-shadow-sm">
                BananaBread
              </span>

                            {/* Version Badge */}
                            <span
                                className="absolute -bottom-1 -left-2 text-[10px] font-medium text-slate-400 bg-slate-50/80 dark:bg-slate-700/80 px-1.5 rounded-full border border-slate-100 dark:border-slate-600">
                v24
              </span>
                        </h1>
                    </div>
                    ...
                    {loadingStatus !== 'success' && (
                        <span
                            className="text-xs flex items-center gap-1 bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 px-2 py-1 rounded">
            ...
            {showPrereqSelector && (
                <div className="fixed inset-0 bg-slate-900/40 flex items-center justify-center z-70 backdrop-blur-sm">
                    <div
                        className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-xl max-w-lg w-full animate-in zoom-in-95 border border-slate-200 dark:border-slate-700">
                        <div className="flex items-start gap-3 mb-4">
                            <div
                                className="bg-amber-100 dark:bg-amber-900/40 p-2 rounded-full text-amber-600 dark:text-amber-400">
                        ...
                        <div
                            className="max-h-60 overflow-y-auto custom-scrollbar border dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-900 p-2 mb-4">
            ...
            {isEditing && (
                <div
                    className="fixed inset-0 bg-slate-900/30 flex items-start justify-center pt-20 z-60 backdrop-blur-sm">
                    <div
                        className="w-full max-w-2xl bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-2xl animate-in slide-in-from-bottom-4 border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4" ref={wrapperRef}>
                            <div className="md:col-span-2 relative">
                                ...
                                {showSuggestions && (
                                    <div
                                        className="absolute w-full bg-white dark:bg-slate-700 border dark:border-slate-600 shadow-xl rounded-lg mt-1 max-h-48 overflow-y-auto z-50">
                                        {suggestions.map((s) => (
                                            <button
                                                key={s.id}
                                                onClick={() => {
                    ...
                    {Array.from({length: semesterCount}, (_, i) => i + 1).map((semNum) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Course List */}
                                <div
                                    className="flex-1 overflow-y-auto p-2 space-y-2 custom-scrollbar bg-slate-50/50 dark:bg-slate-900/50">
                                    {semCourses.length === 0 && (
                                        <div
                                            className="h-full flex flex-col items-center justify-center text-slate-300 dark:text-slate-600 gap-2">
                                            <div
            ...
            {/* FOOTER STATS */}
            <div
                className="glass-dark glass-dark-border text-white p-3 flex justify-between items-center z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
